import { balancedFocus, initialCeoPersonal, initialCeoPortfolio, buildInitialBoard, fnv1a, generateMaTargets, initialCompetitorStrikeState, initialCrisisState, initialPoliticsState, initialInsuranceState, initialMacroState, initialIpoState, initialLaborState, initialLegalState, initialTakeoverState, personaBits, resolveLocationProfile, stream, type CompanyState } from '@boardroom/shared';
